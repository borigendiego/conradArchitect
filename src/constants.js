...
const MEMBERS_PROFILES = [
    {
        ...
        description: (
            <div className={'description-wrapper'}>
                <p>
                    James Attended California State Polytechnic University at Pomona in
                    their School of Environmental Design.  He then went on to work for Newport Beach
                    designer, James Adams, working on restaurants and hotel projects around the United States.  In 1986,
                    James founded his own design/ build firm, Pacific
                    Designers and Builders.  James was also a licensed general building contractor and began designing and
                    building custom homes in South Orange
                    County, primarily in Laguna Beach.  This unique combination of skills allowed James  to design homes
                    that were both beautiful and structurally
                    efficient to build.
                </p>
                <p>
                    James then founded Conrad Development and he developed numerous high end custom homes in
                    Laguna Beach, California and Scottsdale,
                    Arizona.  He honed his skills in all aspects of development from selection of property, Architectural and
                    Interior Design, procurement of entitlements,
                    Finance, construction and marketing of properties.  This full spectrum of expertise allows James to guide
                    his clients through the entire development
                    process.
                </p>
                <p>
                    In 2000, James suspended the construction side of his business and developed relationships
                    with highly qualified builders and interior
                    designers to ensure his projects were built as well as they are designed.  James now focuses his energy
                    on the architectural discipline, designing high
